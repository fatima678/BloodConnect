// lib/screens/Donor/Donor_Blood_Bank_Map_Screen.dart
import 'package:flutter/material.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:geolocator/geolocator.dart';
import '../../theme.dart';

class DonorBloodBankMapScreen extends StatefulWidget {
  final Map<String, dynamic> selectedBank;

  const DonorBloodBankMapScreen({super.key, required this.selectedBank});

  @override
  State<DonorBloodBankMapScreen> createState() => _DonorBloodBankMapScreenState();
}

class _DonorBloodBankMapScreenState extends State<DonorBloodBankMapScreen> {
