...
class _DonorProfileTabContentState extends State<DonorProfileTabContent> {
  ...
  DocumentReference<Map<String, dynamic>>? get _donorDoc {
  ...
  String _cacheKey(String uid) {
    return 'cached_donor_profile_$uid';
  }
  ...
  Future<bool> _loadCachedProfile(String uid) async {
    try {
      ...
      debugPrint('Load cached donor profile error: $e');
      return false;
    }
  }
  ...
  Future<void> _cacheProfile({
    ...
    try {
      ...
      await prefs.remove('cached_donor_profile');
    } catch (e) {
      debugPrint('Cache donor profile error: $e');
    }
  }
  ...
  Future<void> _clearCachedProfile(String uid) async {
    try {
      ...
      debugPrint('Clear cached donor profile error: $e');
    }
  }

  Future<void> _fetchProfileFromFirestore(String uid) async {
    final docRef = _donorDoc;
    ...
    try {
      ...
      debugPrint('Fetch donor profile error: $e');
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Your donor profile is not created yet. Click the button below to add your profile details.',
                textAlign: TextAlign.center,
                style: TextStyle(
