...
class VolunteerVerifyEmailScreen extends StatefulWidget {
  const VolunteerVerifyEmailScreen({super.key});

  @override
  State<VolunteerVerifyEmailScreen> createState() =>
      _VolunteerVerifyEmailScreenState();
}

class _VolunteerVerifyEmailScreenState
    extends State<VolunteerVerifyEmailScreen> {
  ...
  Future<String?> _getFcmToken() async {
    try {
      ...
      debugPrint(
        "VOLUNTEER VERIFY FCM Permission: ${settings.authorizationStatus}",
      );
      ...
      debugPrint("VOLUNTEER VERIFY FCM Token: $fcmToken");
      ...
      debugPrint("VOLUNTEER VERIFY FCM Token Error: $e");
      return null;
    }
  }
